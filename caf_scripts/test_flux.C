...
void test_flux(){
  ...
  Spectrum s_Nu0_CV = new Spectrum("ENu_CV", binsEnergy, loader, kTrueNuE_0, kNuFluxSelection, kSpillUnweighted);
  Spectrum s_Nu0_uni1 = new Spectrum("ENu_uni1", binsEnergy, loader, kTrueNuE_0, kNuFluxSelection, weis[0]);
