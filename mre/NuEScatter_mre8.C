/*
MRE8 is the minimum reproducible example when running the original cuts on the pure nue sample. v09_58
...
const string surName = "mre8";

void NuEScatter_mre8(bool reload = true)
{
...
gSystem->Exec("cp NuEScatterCuts.h NuEScatterRecoVars.h TrueEventCategories.h NuEScatter_mre8.C " + saveDir);
}